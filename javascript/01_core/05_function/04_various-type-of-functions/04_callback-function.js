...
console.log(apply(decrease, 25));  // 24

// 콜백 함수가 고차 함수 내부에서만 호출된다면
// 콜백 함수를 익명 함수 리터럴로 정의해 곧바로 고차 함수에 전달하는 것이 일반적이다
console.log(apply(function(value) {return value ** 2;}, 7));  // ** : 제곱  // 49

console.log([3, 2, 1, 5, 4].sort(function(left, right) {return right - left;}));  // sort : 정렬 // right - left : 내림차순 // left - right : 오름차순