...
console.log(Student.prototype.introduce);  // [Function: introduce] : 클래스 내부에 정의한 매소드는 클래스.prototype에 저장된다
...
let teacher = new Teacher("홍길동");  // 인수로 초기값 전달하며 객체 생성
teacher.introduce();  // 메소드 호출
...
for (method in student) {
    console.log(`반복문 student: ${method}`);  // introduce 메소드 출력되지 않음
}
