...
public class ProblemsOfUsingDirectSQLTests {
    ...
    * */
    ...
    void testDirectSelectSQL() throws SQLException {
        ...
        ResultSet rset = stmt.executeQuery(query);  // ResultSet 이라는 객체로 반환
    ...
    * */
    ...
    void testEquals() throws SQLException {
        ...
        //then
        Assertions.assertFalse(menu1 == menu2);  // assertFalse : 둘이 다른지 확인
        Assertions.assertEquals(menu1.getMenuName(), menu2.getMenuName());  // assertEquals : 둘이 같은지 확인
