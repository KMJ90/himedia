...
public class ManyToOneServiceTests {
    ...
    void setManyToOneFindTest() {
        ...
        assertNotNull(category);  // assertNotNull : null 값이 아닌지 확인
    }

    @DisplayName("N:1 연관관계 객체 지향 쿼리(JPQL)을 이용한 조회 테스트")
    @Test
    void setManyToOneJpqlFindTest() {
        // given
        int menuCode = 10;
    ...
    void setManyToOneInsertTest(int menuCode, String menuName, int menuPrice, int categoryCode, String categoryName, String orderableStatus) {
        // given
