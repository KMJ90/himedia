...
@Controller  // @Controller : 컨트롤러 클래스에 붙여줌
...
public class LectureController {
    ...
    public ModelAndView conditional(ModelAndView mv) {
        ...
        memberList.add(new MemberDTO("판다", 20, '여', "서울시 강남구 8강"));
        memberList.add(new MemberDTO("다람쥐", 900, '무', "서울시 강남구 10강"));
        memberList.add(new MemberDTO("양", 300, '여', "하이미디어 15층"));
        memberList.add(new MemberDTO("판다", 100, '여', "서울시 강남구 1강"));
